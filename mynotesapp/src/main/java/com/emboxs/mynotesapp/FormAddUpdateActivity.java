...
import com.emboxs.mynotesapp.db.NoteHelper;
...
public class FormAddUpdateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_submit){
            ...
            /*jika fieldnya masih kosong tampilkan error */
            if (TextUtils.isEmpty( (title) )){
                isEmpty = true;
                edtTitle.setError( "Fields tidak boleh kosong" );
            }
            if (!isEmpty){
                ...
                /*Jika merupakan edit set result nya UPDATE, dan jika bukan maka setresult nya ADD*/
                if (isEdit){
